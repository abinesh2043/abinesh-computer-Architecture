...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/react-code-view.234ae39ff1fa1232236c.module.css" />
  ...
  <title>computer-architecture/4 pipelining.cpp at main · Thirissha/computer-architecture</title>
  ...
  <meta name="request-id" content="D721:3FDB86:145C8CC:16600C0:66AB8D77" data-turbo-transient="true" /><meta name="html-safe-nonce" content="c67d0c119599274c1268a564d4cbd7e81292c70b46299332928ac1a4175c0d56" data-turbo-transient="true" /><meta name="visitor-payload" content="" data-turbo-transient="true" /><meta name="visitor-hmac" content="6429ed060b41bf87790610e557cf2a2c31bfc43fb8df8a986ce9a2d2ba2e0fdd" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="132431568" /><meta name="octolytics-actor-login" content="abinesh2043" /><meta name="octolytics-actor-hash" content="7298fabc0e34830062a7bd62ffcffdf2b5f6a4646fb7ba61dd14979e35f58167" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/Thirissha/computer-architecture/blob/main/4%20pipelining.cpp" />

      <meta name="twitter:image:src" content="https://opengraph.githubassets.com/9f16d062dedf0a1687ad186292080ed651dcc1a1cb61598d314b237df60c214a/Thirissha/computer-architecture" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="computer-architecture/4 pipelining.cpp at main · Thirissha/computer-architecture" /><meta name="twitter:description" content="Contribute to Thirissha/computer-architecture development by creating an account on GitHub." />
  <meta property="og:image" content="https://opengraph.githubassets.com/9f16d062dedf0a1687ad186292080ed651dcc1a1cb61598d314b237df60c214a/Thirissha/computer-architecture" /><meta property="og:image:alt" content="Contribute to Thirissha/computer-architecture development by creating an account on GitHub." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="computer-architecture/4 pipelining.cpp at main · Thirissha/computer-architecture" /><meta property="og:url" content="https://github.com/Thirissha/computer-architecture/blob/main/4%20pipelining.cpp" /><meta property="og:description" content="Contribute to Thirissha/computer-architecture development by creating an account on GitHub." />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/132431568/ws?session=eyJ2IjoiVjMiLCJ1IjoxMzI0MzE1NjgsInMiOjE0MzU3MTc1NjgsImMiOjIwODg5NTcyOTcsInQiOjE3MjI1MTg5MTJ9--b1d108325fd23648396e52ec22b98c26daffeca459d4af009fe36fc144b1ea37" data-refresh-url="/_alive" data-session-id="87f5e0763cc9197f52080e5f2dc02a4c954f5e0b7d9e425604f762815ae46b1b">
...
>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
      <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-77105f8e-3d17-4959-a171-cd87f3a7b926" id="dialog-show-dialog-77105f8e-3d17-4959-a171-cd87f3a7b926" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-bg-transparent p-0 color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>

<dialog-helper>
  <dialog data-target="deferred-side-panel.panel" id="dialog-77105f8e-3d17-4959-a171-cd87f3a7b926" aria-modal="true" aria-labelledby="dialog-77105f8e-3d17-4959-a171-cd87f3a7b926-title" aria-describedby="dialog-77105f8e-3d17-4959-a171-cd87f3a7b926-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade Overlay--placement-left SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-77105f8e-3d17-4959-a171-cd87f3a7b926-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-77105f8e-3d17-4959-a171-cd87f3a7b926" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="dialog-77105f8e-3d17-4959-a171-cd87f3a7b926-title">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-bde7869a-c20e-4ba4-bddb-acf25967296b" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-b0b3dd29-a936-4c95-96f4-4312eed0f41d" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-27039ae6-4c93-47be-8bb3-885b2d920e85" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-item-id="projects" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROJECTS&quot;,&quot;label&quot;:null}" id="item-9016b451-3308-49b1-842a-57f2312d1af0" href="/projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-7ba5d0d8-0bb6-4fa6-a167-0907e78b4609" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-9cfaf7e1-36ed-4c43-a05b-bac7b8019a66" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-ca43671b-e673-4476-ac80-0b5b6c3589ff" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-0aae918d-583c-4a87-98f4-41b1ce412167" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<qbsearch-input class="search-input" data-scope="repo:Thirissha/computer-architecture" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="_wTg4zRGodi4EwstmmB74UsPVM-GDqHyolrjCIQAsrCk3qM3j_9LCNPZSPOj8DVuE5fbuVU6xAUPrbCdZcUYJA" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="Thirissha/computer-architecture" data-current-org="" data-current-owner="Thirissha" data-logged-in="true" data-copilot-chat-enabled="false" data-nl-search-enabled="false">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-258288f9-fd91-4490-be84-55b9597114bb" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-258288f9-fd91-4490-be84-55b9597114bb" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="NFhHhWl2rmbMombMeubH-qiTSf7Pl9IH0c5bHsUVPgsUYUUOX8QManGtw6N3ZgOKWZnYX3dYgOVG2PwDo4FyMg" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="rc1T2TJtwuFCG7jVZW36Z7jm3iZN9do0lbYU9TLeOA6kt8gHNkE-pqmia4QETJFqCfh0zwbwXIxBzQIAyGTY9g" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="2jHvWNh--_P9aNIxFfuDzzoqwiHUDTTyN_Z6kLLBBPasev_jLqlR95WqUiCU7mG7JDPOFxvY-kQwap4IIqlHTg" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input>    <input type="hidden" value="BAcUuIv6IY3B1rKRGPS9bdFFU1aB3IYs-Gprx4txzgSk-oiAOrY4JV1op0zJPrOpCACGdZcpXmNrKAkDulfCXQ" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
...
</button><tool-tip id="tooltip-34692544-5531-4a1e-beac-60a582d8ae4b" for="global-create-menu-anchor" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
...
>
  ...
  <div data-target="react-partial.reactRoot"></div>
          ...
          <a href="/issues" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-ada6b382-4240-4525-b3cd-9d8010abfc34" aria-labelledby="tooltip-4cb66b4a-f9ca-4419-9e29-61aac07c157b" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened Button-visual">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
</a><tool-tip id="tooltip-4cb66b4a-f9ca-4419-9e29-61aac07c157b" for="icon-button-ada6b382-4240-4525-b3cd-9d8010abfc34" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Issues</tool-tip>

          <a href="/pulls" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-bc65ed3b-bf63-4f19-ad26-c7f06a936ec0" aria-labelledby="tooltip-fb1bc624-6432-4b03-b544-75e83d8d14c8" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request Button-visual">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
</a><tool-tip id="tooltip-fb1bc624-6432-4b03-b544-75e83d8d14c8" for="icon-button-bc65ed3b-bf63-4f19-ad26-c7f06a936ec0" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Pull requests</tool-tip>

        </div>

        <notification-indicator data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTMyNDMxNTY4IiwidCI6MTcyMjUxODkxMn0=--9937423150abd0dc99a558bdb8fbdcc0b8d8d6198cd15ab05abc245f09ad909d" data-indicator-mode="none" data-tooltip-global="You have unread notifications" data-tooltip-unavailable="Notifications are unavailable at the moment." data-tooltip-none="You have no unread notifications" data-header-redesign-enabled="true" data-fetch-indicator-src="/notifications/indicator" data-fetch-indicator-enabled="true" data-view-component="true" class="js-socket-channel">
...
<site-header-logged-in-user-menu>
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-00501fca-7fd0-49db-9fbb-2e2290844f33-button" popovertarget="action-menu-00501fca-7fd0-49db-9fbb-2e2290844f33-overlay" aria-controls="action-menu-00501fca-7fd0-49db-9fbb-2e2290844f33-list" aria-haspopup="true" aria-labelledby="tooltip-e1454f96-5780-4463-904a-cd4b7b3b1191" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-e1454f96-5780-4463-904a-cd4b7b3b1191" for="action-menu-00501fca-7fd0-49db-9fbb-2e2290844f33-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-00501fca-7fd0-49db-9fbb-2e2290844f33-overlay" anchor="action-menu-00501fca-7fd0-49db-9fbb-2e2290844f33-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-00501fca-7fd0-49db-9fbb-2e2290844f33-button" id="action-menu-00501fca-7fd0-49db-9fbb-2e2290844f33-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-50132232-f280-4f95-8f78-935ce2bce407" href="/Thirissha/computer-architecture" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-029829a4-9e0c-4a1f-b3f3-8f16c5935c6f" href="/Thirissha/computer-architecture/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-3c5bdeb9-5712-419d-aecd-46bdb8686036" href="/Thirissha/computer-architecture/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-d417ecc0-0a2d-4048-9cba-79e315696119" href="/Thirissha/computer-architecture/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-f6e3612b-6c25-4d34-88dd-41b97f3e754f" href="/Thirissha/computer-architecture/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-table">
    <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25ZM6.5 6.5v8h7.75a.25.25 0 0 0 .25-.25V6.5Zm8-1.5V1.75a.25.25 0 0 0-.25-.25H6.5V5Zm-13 1.5v7.75c0 .138.112.25.25.25H5v-8ZM5 5V1.5H1.75a.25.25 0 0 0-.25.25V5Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-883a9e6f-bc14-4ec5-820f-f81dc7eef311" href="/Thirissha/computer-architecture/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-302327c0-3bb9-4293-89e2-d513fb0dbd2d" href="/Thirissha/computer-architecture/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <button id="icon-button-e2b3ebc6-d3cf-4648-983c-a1b5d78f78cd" aria-labelledby="tooltip-ca76647a-dc47-456f-8c49-c9c245d1109b" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-ca76647a-dc47-456f-8c49-c9c245d1109b" for="icon-button-e2b3ebc6-d3cf-4648-983c-a1b5d78f78cd" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  <div >
    ...
    <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTMyNDMxNTY4IiwidCI6MTcyMjUxODkxMn0=--9937423150abd0dc99a558bdb8fbdcc0b8d8d6198cd15ab05abc245f09ad909d" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<react-app
  ...
  initial-path="/Thirissha/computer-architecture/blob/main/4%20pipelining.cpp"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":true,"fileTree":{"":{"items":[{"name":"16 bit add.png","path":"16 bit add.png","contentType":"file"},{"name":"16 bit div.png","path":"16 bit div.png","contentType":"file"},{"name":"16 bit mul.png","path":"16 bit mul.png","contentType":"file"},{"name":"2 input nand.circ","path":"2 input nand.circ","contentType":"file"},{"name":"3 input nand.circ","path":"3 input nand.circ","contentType":"file"},{"name":"4 pipelining.cpp","path":"4 pipelining.cpp","contentType":"file"},{"name":"8 bit add.jpeg","path":"8 bit add.jpeg","contentType":"file"},{"name":"8 bit div","path":"8 bit div","contentType":"file"},{"name":"8 bit sub.jpeg","path":"8 bit sub.jpeg","contentType":"file"},{"name":"Screenshot (1).png","path":"Screenshot (1).png","contentType":"file"},{"name":"WhatsApp Image 2024-07-22 at 12.23.26 PM.jpeg","path":"WhatsApp Image 2024-07-22 at 12.23.26 PM.jpeg","contentType":"file"},{"name":"WhatsApp Image 2024-07-22 at 12.23.28 PM.jpeg","path":"WhatsApp Image 2024-07-22 at 12.23.28 PM.jpeg","contentType":"file"},{"name":"WhatsApp Image 2024-07-22 at 12.23.44 PM.jpeg","path":"WhatsApp Image 2024-07-22 at 12.23.44 PM.jpeg","contentType":"file"},{"name":"and.circ","path":"and.circ","contentType":"file"},{"name":"b to o.cpp","path":"b to o.cpp","contentType":"file"},{"name":"bus arbitration.cpp","path":"bus arbitration.cpp","contentType":"file"},{"name":"ca25.cpp","path":"ca25.cpp","contentType":"file"},{"name":"cache meemory.cpp","path":"cache meemory.cpp","contentType":"file"},{"name":"cpu.cpp","path":"cpu.cpp","contentType":"file"},{"name":"d to h.cpp","path":"d to h.cpp","contentType":"file"},{"name":"emmory add.cpp","path":"emmory add.cpp","contentType":"file"},{"name":"fact.cpp","path":"fact.cpp","contentType":"file"},{"name":"factorial  gnu.png","path":"factorial  gnu.png","contentType":"file"},{"name":"full adder logic gates.png","path":"full adder logic gates.png","contentType":"file"},{"name":"full adder.circ","path":"full adder.circ","contentType":"file"},{"name":"full sub logic gates.png","path":"full sub logic gates.png","contentType":"file"},{"name":"hald subractor.circ","path":"hald subractor.circ","contentType":"file"},{"name":"half adder logic gate.png","path":"half adder logic gate.png","contentType":"file"},{"name":"half sub logic gates.png","path":"half sub logic gates.png","contentType":"file"},{"name":"hazards.cpp","path":"hazards.cpp","contentType":"file"},{"name":"largest.cpp","path":"largest.cpp","contentType":"file"},{"name":"non restoring div.cpp","path":"non restoring div.cpp","contentType":"file"},{"name":"nor gate.circ","path":"nor gate.circ","contentType":"file"},{"name":"not.circ","path":"not.circ","contentType":"file"},{"name":"or gate.circ","path":"or gate.circ","contentType":"file"},{"name":"pci interrupts.cpp","path":"pci interrupts.cpp","contentType":"file"},{"name":"ram.cpp","path":"ram.cpp","contentType":"file"},{"name":"restoring div.cpp","path":"restoring div.cpp","contentType":"file"},{"name":"rom.cpp","path":"rom.cpp","contentType":"file"},{"name":"small.cpp","path":"small.cpp","contentType":"file"},{"name":"sorting.cpp","path":"sorting.cpp","contentType":"file"},{"name":"two pipelining.cpp","path":"two pipelining.cpp","contentType":"file"},{"name":"vitual memory.cpp","path":"vitual memory.cpp","contentType":"file"},{"name":"xor gate.circ","path":"xor gate.circ","contentType":"file"}],"totalCount":44}},"fileTreeProcessingTime":3.4611289999999997,"foldersToFetch":[],"repo":{"id":835594244,"defaultBranch":"main","name":"computer-architecture","ownerLogin":"Thirissha","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2024-07-30T12:11:26.000+05:30","ownerAvatar":"https://avatars.githubusercontent.com/u/132975528?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1722339113.0","canEdit":true,"refType":"branch","currentOid":"19cf8c494d2c5f97d3e2bec70abd1bff26f059f9"},"path":"4 pipelining.cpp","currentUser":{"id":132431568,"login":"abinesh2043","userEmail":"abinesha2043.sse@saveetha.com"},"blob":{"rawLines":["#include \u003cstdio.h\u003e\r","#include \u003cstdlib.h\u003e\r","#include \u003cunistd.h\u003e\r","\r","#define NUM_STAGES 4\r","#define BUFFER_SIZE 100\r","\r","typedef struct {\r","    int data;\r","} Instruction;\r","\r","typedef struct {\r","    Instruction instruction;\r","    int valid;\r","} PipelineStage;\r","\r","void fetch(PipelineStage *stage, int data) {\r","    stage-\u003einstruction.data = data;\r","    stage-\u003evalid = 1;\r","    printf(\"Fetch: %d\\n\", data);\r","}\r","\r","void decode(PipelineStage *stage) {\r","    if (stage-\u003evalid) {\r","        printf(\"Decode: %d\\n\", stage-\u003einstruction.data);\r","    }\r","}\r","\r","void execute(PipelineStage *stage) {\r","    if (stage-\u003evalid) {\r","        printf(\"Execute: %d\\n\", stage-\u003einstruction.data);\r","    }\r","}\r","\r","void write_back(PipelineStage *stage) {\r","    if (stage-\u003evalid) {\r","        printf(\"Write Back: %d\\n\", stage-\u003einstruction.data);\r","        stage-\u003evalid = 0;\r","    }\r","}\r","\r","void pipeline_step(PipelineStage pipeline[]) {\r","    // Process stages in reverse order to simulate pipeline progression\r","    write_back(\u0026pipeline[3]);\r","    execute(\u0026pipeline[2]);\r","    decode(\u0026pipeline[1]);\r","    fetch(\u0026pipeline[0], rand() % 100);\r","}\r","\r","void pipeline_shift(PipelineStage pipeline[]) {\r","    for (int i = NUM_STAGES - 1; i \u003e 0; i--) {\r","        pipeline[i] = pipeline[i - 1];\r","    }\r","    pipeline[0].valid = 0; // New fetch stage\r","}\r","\r","int main() {\r","    PipelineStage pipeline[NUM_STAGES] = {0};\r","\r","    for (int cycle = 0; cycle \u003c 10; cycle++) {\r","        printf(\"Cycle %d:\\n\", cycle + 1);\r","        pipeline_step(pipeline);\r","        pipeline_shift(pipeline);\r","        sleep(1); // Simulate time delay for each cycle\r","        printf(\"\\n\");\r","    }\r","\r","    return 0;\r","}\r","\r"],"stylingDirectives":null,"colorizedLines":["#\u003cspan class=\"pl-k\"\u003einclude\u003c/span\u003e \u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026lt;\u003c/span\u003estdio.h\u003cspan class=\"pl-pds\"\u003e\u0026gt;\u003c/span\u003e\u003c/span\u003e","#\u003cspan class=\"pl-k\"\u003einclude\u003c/span\u003e \u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026lt;\u003c/span\u003estdlib.h\u003cspan class=\"pl-pds\"\u003e\u0026gt;\u003c/span\u003e\u003c/span\u003e","#\u003cspan class=\"pl-k\"\u003einclude\u003c/span\u003e \u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026lt;\u003c/span\u003eunistd.h\u003cspan class=\"pl-pds\"\u003e\u0026gt;\u003c/span\u003e\u003c/span\u003e","","#\u003cspan class=\"pl-k\"\u003edefine\u003c/span\u003e \u003cspan class=\"pl-en\"\u003eNUM_STAGES\u003c/span\u003e \u003cspan class=\"pl-c1\"\u003e4\u003c/span\u003e","#\u003cspan class=\"pl-k\"\u003edefine\u003c/span\u003e \u003cspan class=\"pl-en\"\u003eBUFFER_SIZE\u003c/span\u003e \u003cspan class=\"pl-c1\"\u003e100\u003c/span\u003e","","\u003cspan class=\"pl-k\"\u003etypedef\u003c/span\u003e \u003cspan class=\"pl-k\"\u003estruct\u003c/span\u003e {","    \u003cspan class=\"pl-k\"\u003eint\u003c/span\u003e data;","} Instruction;","","\u003cspan class=\"pl-k\"\u003etypedef\u003c/span\u003e \u003cspan class=\"pl-k\"\u003estruct\u003c/span\u003e {","    Instruction instruction;","    \u003cspan class=\"pl-k\"\u003eint\u003c/span\u003e valid;","} PipelineStage;","","\u003cspan class=\"pl-k\"\u003evoid\u003c/span\u003e \u003cspan class=\"pl-en\"\u003efetch\u003c/span\u003e(PipelineStage *stage, \u003cspan class=\"pl-k\"\u003eint\u003c/span\u003e data) {","    stage-\u0026gt;\u003cspan class=\"pl-smi\"\u003einstruction\u003c/span\u003e.\u003cspan class=\"pl-smi\"\u003edata\u003c/span\u003e = data;","    stage-\u0026gt;\u003cspan class=\"pl-smi\"\u003evalid\u003c/span\u003e = \u003cspan class=\"pl-c1\"\u003e1\u003c/span\u003e;","    \u003cspan class=\"pl-c1\"\u003eprintf\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003eFetch: %d\u003cspan class=\"pl-cce\"\u003e\\n\u003c/span\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e, data);","}","","\u003cspan class=\"pl-k\"\u003evoid\u003c/span\u003e \u003cspan class=\"pl-en\"\u003edecode\u003c/span\u003e(PipelineStage *stage) {","    \u003cspan class=\"pl-k\"\u003eif\u003c/span\u003e (stage-\u0026gt;\u003cspan class=\"pl-smi\"\u003evalid\u003c/span\u003e) {","        \u003cspan class=\"pl-c1\"\u003eprintf\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003eDecode: %d\u003cspan class=\"pl-cce\"\u003e\\n\u003c/span\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e, stage-\u0026gt;\u003cspan class=\"pl-smi\"\u003einstruction\u003c/span\u003e.\u003cspan class=\"pl-smi\"\u003edata\u003c/span\u003e);","    }","}","","\u003cspan class=\"pl-k\"\u003evoid\u003c/span\u003e \u003cspan class=\"pl-en\"\u003eexecute\u003c/span\u003e(PipelineStage *stage) {","    \u003cspan class=\"pl-k\"\u003eif\u003c/span\u003e (stage-\u0026gt;\u003cspan class=\"pl-smi\"\u003evalid\u003c/span\u003e) {","        \u003cspan class=\"pl-c1\"\u003eprintf\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003eExecute: %d\u003cspan class=\"pl-cce\"\u003e\\n\u003c/span\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e, stage-\u0026gt;\u003cspan class=\"pl-smi\"\u003einstruction\u003c/span\u003e.\u003cspan class=\"pl-smi\"\u003edata\u003c/span\u003e);","    }","}","","\u003cspan class=\"pl-k\"\u003evoid\u003c/span\u003e \u003cspan class=\"pl-en\"\u003ewrite_back\u003c/span\u003e(PipelineStage *stage) {","    \u003cspan class=\"pl-k\"\u003eif\u003c/span\u003e (stage-\u0026gt;\u003cspan class=\"pl-smi\"\u003evalid\u003c/span\u003e) {","        \u003cspan class=\"pl-c1\"\u003eprintf\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003eWrite Back: %d\u003cspan class=\"pl-cce\"\u003e\\n\u003c/span\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e, stage-\u0026gt;\u003cspan class=\"pl-smi\"\u003einstruction\u003c/span\u003e.\u003cspan class=\"pl-smi\"\u003edata\u003c/span\u003e);","        stage-\u0026gt;\u003cspan class=\"pl-smi\"\u003evalid\u003c/span\u003e = \u003cspan class=\"pl-c1\"\u003e0\u003c/span\u003e;","    }","}","","\u003cspan class=\"pl-k\"\u003evoid\u003c/span\u003e \u003cspan class=\"pl-en\"\u003epipeline_step\u003c/span\u003e(PipelineStage pipeline[]) {","    \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Process stages in reverse order to simulate pipeline progression\u003c/span\u003e","    \u003cspan class=\"pl-c1\"\u003ewrite_back\u003c/span\u003e(\u0026amp;pipeline[\u003cspan class=\"pl-c1\"\u003e3\u003c/span\u003e]);","    \u003cspan class=\"pl-c1\"\u003eexecute\u003c/span\u003e(\u0026amp;pipeline[\u003cspan class=\"pl-c1\"\u003e2\u003c/span\u003e]);","    \u003cspan class=\"pl-c1\"\u003edecode\u003c/span\u003e(\u0026amp;pipeline[\u003cspan class=\"pl-c1\"\u003e1\u003c/span\u003e]);","    \u003cspan class=\"pl-c1\"\u003efetch\u003c/span\u003e(\u0026amp;pipeline[\u003cspan class=\"pl-c1\"\u003e0\u003c/span\u003e], \u003cspan class=\"pl-c1\"\u003erand\u003c/span\u003e() % \u003cspan class=\"pl-c1\"\u003e100\u003c/span\u003e);","}","","\u003cspan class=\"pl-k\"\u003evoid\u003c/span\u003e \u003cspan class=\"pl-en\"\u003epipeline_shift\u003c/span\u003e(PipelineStage pipeline[]) {","    \u003cspan class=\"pl-k\"\u003efor\u003c/span\u003e (\u003cspan class=\"pl-k\"\u003eint\u003c/span\u003e i = NUM_STAGES - \u003cspan class=\"pl-c1\"\u003e1\u003c/span\u003e; i \u0026gt; \u003cspan class=\"pl-c1\"\u003e0\u003c/span\u003e; i--) {","        pipeline[i] = pipeline[i - \u003cspan class=\"pl-c1\"\u003e1\u003c/span\u003e];","    }","    pipeline[\u003cspan class=\"pl-c1\"\u003e0\u003c/span\u003e].\u003cspan class=\"pl-smi\"\u003evalid\u003c/span\u003e = \u003cspan class=\"pl-c1\"\u003e0\u003c/span\u003e; \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e New fetch stage\u003c/span\u003e","}","","\u003cspan class=\"pl-k\"\u003eint\u003c/span\u003e \u003cspan class=\"pl-en\"\u003emain\u003c/span\u003e() {","    PipelineStage pipeline[NUM_STAGES] = {\u003cspan class=\"pl-c1\"\u003e0\u003c/span\u003e};","","    \u003cspan class=\"pl-k\"\u003efor\u003c/span\u003e (\u003cspan class=\"pl-k\"\u003eint\u003c/span\u003e cycle = \u003cspan class=\"pl-c1\"\u003e0\u003c/span\u003e; cycle \u0026lt; \u003cspan class=\"pl-c1\"\u003e10\u003c/span\u003e; cycle++) {","        \u003cspan class=\"pl-c1\"\u003eprintf\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003eCycle %d:\u003cspan class=\"pl-cce\"\u003e\\n\u003c/span\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e, cycle + \u003cspan class=\"pl-c1\"\u003e1\u003c/span\u003e);","        \u003cspan class=\"pl-c1\"\u003epipeline_step\u003c/span\u003e(pipeline);","        \u003cspan class=\"pl-c1\"\u003epipeline_shift\u003c/span\u003e(pipeline);","        \u003cspan class=\"pl-c1\"\u003esleep\u003c/span\u003e(\u003cspan class=\"pl-c1\"\u003e1\u003c/span\u003e); \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Simulate time delay for each cycle\u003c/span\u003e","        \u003cspan class=\"pl-c1\"\u003eprintf\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003cspan class=\"pl-cce\"\u003e\\n\u003c/span\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e);","    }","","    \u003cspan class=\"pl-k\"\u003ereturn\u003c/span\u003e \u003cspan class=\"pl-c1\"\u003e0\u003c/span\u003e;","}",""],"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/Thirissha/computer-architecture/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false},"displayName":"4 pipelining.cpp","displayUrl":"https://github.com/Thirissha/computer-architecture/blob/main/4%20pipelining.cpp?raw=true","headerInfo":{"blobSize":"1.57 KB","deleteTooltip":"Fork this repository and delete the file","editTooltip":"Fork this repository and edit the file","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"2f00856","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2FThirissha%2Fcomputer-architecture%2Fblob%2Fmain%2F4%2520pipelining.cpp","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"70","truncatedSloc":"57"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"C++","languageID":43,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/Thirissha/computer-architecture/blob/main/4%20pipelining.cpp","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/Thirissha/computer-architecture/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/Thirissha/computer-architecture/raw/main/4%20pipelining.cpp","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"Instruction","kind":"type","ident_start":148,"ident_end":159,"extent_start":113,"extent_end":160,"fully_qualified_name":"Instruction","ident_utf16":{"start":{"line_number":9,"utf16_col":2},"end":{"line_number":9,"utf16_col":13}},"extent_utf16":{"start":{"line_number":7,"utf16_col":0},"end":{"line_number":9,"utf16_col":14}}},{"name":"PipelineStage","kind":"type","ident_start":230,"ident_end":243,"extent_start":164,"extent_end":244,"fully_qualified_name":"PipelineStage","ident_utf16":{"start":{"line_number":14,"utf16_col":2},"end":{"line_number":14,"utf16_col":15}},"extent_utf16":{"start":{"line_number":11,"utf16_col":0},"end":{"line_number":14,"utf16_col":16}}},{"name":"fetch","kind":"function","ident_start":253,"ident_end":258,"extent_start":248,"extent_end":389,"fully_qualified_name":"fetch","ident_utf16":{"start":{"line_number":16,"utf16_col":5},"end":{"line_number":16,"utf16_col":10}},"extent_utf16":{"start":{"line_number":16,"utf16_col":0},"end":{"line_number":20,"utf16_col":1}}},{"name":"decode","kind":"function","ident_start":398,"ident_end":404,"extent_start":393,"extent_end":521,"fully_qualified_name":"decode","ident_utf16":{"start":{"line_number":22,"utf16_col":5},"end":{"line_number":22,"utf16_col":11}},"extent_utf16":{"start":{"line_number":22,"utf16_col":0},"end":{"line_number":26,"utf16_col":1}}},{"name":"execute","kind":"function","ident_start":530,"ident_end":537,"extent_start":525,"extent_end":655,"fully_qualified_name":"execute","ident_utf16":{"start":{"line_number":28,"utf16_col":5},"end":{"line_number":28,"utf16_col":12}},"extent_utf16":{"start":{"line_number":28,"utf16_col":0},"end":{"line_number":32,"utf16_col":1}}},{"name":"write_back","kind":"function","ident_start":664,"ident_end":674,"extent_start":659,"extent_end":822,"fully_qualified_name":"write_back","ident_utf16":{"start":{"line_number":34,"utf16_col":5},"end":{"line_number":34,"utf16_col":15}},"extent_utf16":{"start":{"line_number":34,"utf16_col":0},"end":{"line_number":39,"utf16_col":1}}},{"name":"pipeline_step","kind":"function","ident_start":831,"ident_end":844,"extent_start":826,"extent_end":1074,"fully_qualified_name":"pipeline_step","ident_utf16":{"start":{"line_number":41,"utf16_col":5},"end":{"line_number":41,"utf16_col":18}},"extent_utf16":{"start":{"line_number":41,"utf16_col":0},"end":{"line_number":47,"utf16_col":1}}},{"name":"pipeline_shift","kind":"function","ident_start":1083,"ident_end":1097,"extent_start":1078,"extent_end":1270,"fully_qualified_name":"pipeline_shift","ident_utf16":{"start":{"line_number":49,"utf16_col":5},"end":{"line_number":49,"utf16_col":19}},"extent_utf16":{"start":{"line_number":49,"utf16_col":0},"end":{"line_number":54,"utf16_col":1}}},{"name":"main","kind":"function","ident_start":1278,"ident_end":1282,"extent_start":1274,"extent_end":1602,"fully_qualified_name":"main","ident_utf16":{"start":{"line_number":56,"utf16_col":4},"end":{"line_number":56,"utf16_col":8}},"extent_utf16":{"start":{"line_number":56,"utf16_col":0},"end":{"line_number":68,"utf16_col":1}}}]}},"copilotInfo":{"documentationUrl":"https://docs.github.com/copilot/overview-of-github-copilot/about-github-copilot-for-individuals","notices":{"codeViewPopover":{"dismissed":false,"dismissPath":"/settings/dismiss-notice/code_view_copilot_popover"}},"userAccess":{"hasSubscriptionEnded":false,"orgHasCFBAccess":false,"userHasCFIAccess":false,"userHasOrgs":false,"userIsOrgAdmin":false,"userIsOrgMember":false,"business":null,"featureRequestInfo":null}},"copilotAccessAllowed":false,"csrf_tokens":{"/Thirissha/computer-architecture/branches":{"post":"bCrdNYD2u4bNn5H5tZJgyzfoKoyR4qui_PRCWUFyFnRS0fr1_RTAnsb9z-iFFcPD5c9sBxdBwoZfp5ULn0omAQ"},"/repos/preferences":{"post":"B9DqsUsKDnKmjakI1i3TUsHi2jw9xPCsdfQK4aOgkmRE5dJN9pyHvRA5FUg5rA9TJ4TecnjYG-cssrNzbr6JQQ"}}},"title":"computer-architecture/4 pipelining.cpp at main · Thirissha/computer-architecture","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-3a63a487027b.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":true,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
<div id="LC3" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">#<span class="pl-k">include</span> <span class="pl-s"><span class="pl-pds">&lt;</span>unistd.h<span class="pl-pds">&gt;</span></span></div>
<div id="LC4" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC5" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">#<span class="pl-k">define</span> <span class="pl-en">NUM_STAGES</span> <span class="pl-c1">4</span></div>
<div id="LC6" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">#<span class="pl-k">define</span> <span class="pl-en">BUFFER_SIZE</span> <span class="pl-c1">100</span></div>
...
<div id="LC9" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class="pl-k">int</span> data;</div>
<div id="LC10" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">} Instruction;</div>
<div id="LC11" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC12" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-k">typedef</span> <span class="pl-k">struct</span> {</div>
<div id="LC13" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    Instruction instruction;</div>
<div id="LC14" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class="pl-k">int</span> valid;</div>
<div id="LC15" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">} PipelineStage;</div>
<div id="LC16" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC17" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-k">void</span> <span class="pl-en">fetch</span>(PipelineStage *stage, <span class="pl-k">int</span> data) {</div>
<div id="LC18" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-16 ">    stage-&gt;<span class="pl-smi">instruction</span>.<span class="pl-smi">data</span> = data;</div>
<div id="LC19" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-16 ">    stage-&gt;<span class="pl-smi">valid</span> = <span class="pl-c1">1</span>;</div>
<div id="LC20" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-16 ">    <span class="pl-c1">printf</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Fetch: %d<span class="pl-cce">\n</span><span class="pl-pds">&quot;</span></span>, data);</div>
...
<div id="LC23" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-k">void</span> <span class="pl-en">decode</span>(PipelineStage *stage) {</div>
<div id="LC24" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-22 ">    <span class="pl-k">if</span> (stage-&gt;<span class="pl-smi">valid</span>) {</div>
<div id="LC25" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-22 ">        <span class="pl-c1">printf</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Decode: %d<span class="pl-cce">\n</span><span class="pl-pds">&quot;</span></span>, stage-&gt;<span class="pl-smi">instruction</span>.<span class="pl-smi">data</span>);</div>
<div id="LC26" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-22 ">    }</div>
...
<div id="LC29" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-k">void</span> <span class="pl-en">execute</span>(PipelineStage *stage) {</div>
<div id="LC30" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-28 ">    <span class="pl-k">if</span> (stage-&gt;<span class="pl-smi">valid</span>) {</div>
<div id="LC31" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-28 ">        <span class="pl-c1">printf</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Execute: %d<span class="pl-cce">\n</span><span class="pl-pds">&quot;</span></span>, stage-&gt;<span class="pl-smi">instruction</span>.<span class="pl-smi">data</span>);</div>
<div id="LC32" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-28 ">    }</div>
...
<div id="LC35" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-k">void</span> <span class="pl-en">write_back</span>(PipelineStage *stage) {</div>
<div id="LC36" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-34 ">    <span class="pl-k">if</span> (stage-&gt;<span class="pl-smi">valid</span>) {</div>
<div id="LC37" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-34 ">        <span class="pl-c1">printf</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Write Back: %d<span class="pl-cce">\n</span><span class="pl-pds">&quot;</span></span>, stage-&gt;<span class="pl-smi">instruction</span>.<span class="pl-smi">data</span>);</div>
<div id="LC38" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-34 ">        stage-&gt;<span class="pl-smi">valid</span> = <span class="pl-c1">0</span>;</div>
<div id="LC39" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-34 ">    }</div>
...
<div id="LC42" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-k">void</span> <span class="pl-en">pipeline_step</span>(PipelineStage pipeline[]) {</div>
<div id="LC43" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-41 ">    <span class="pl-c"><span class="pl-c">//</span> Process stages in reverse order to simulate pipeline progression</span></div>
<div id="LC44" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-41 ">    <span class="pl-c1">write_back</span>(&amp;pipeline[<span class="pl-c1">3</span>]);</div>
<div id="LC45" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-41 ">    <span class="pl-c1">execute</span>(&amp;pipeline[<span class="pl-c1">2</span>]);</div>
<div id="LC46" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-41 ">    <span class="pl-c1">decode</span>(&amp;pipeline[<span class="pl-c1">1</span>]);</div>
<div id="LC47" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-41 ">    <span class="pl-c1">fetch</span>(&amp;pipeline[<span class="pl-c1">0</span>], <span class="pl-c1">rand</span>() % <span class="pl-c1">100</span>);</div>
...
<div id="LC50" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-k">void</span> <span class="pl-en">pipeline_shift</span>(PipelineStage pipeline[]) {</div>
<div id="LC51" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-49 ">    <span class="pl-k">for</span> (<span class="pl-k">int</span> i = NUM_STAGES - <span class="pl-c1">1</span>; i &gt; <span class="pl-c1">0</span>; i--) {</div>
<div id="LC52" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-49 ">        pipeline[i] = pipeline[i - <span class="pl-c1">1</span>];</div>
<div id="LC53" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-49 ">    }</div>
<div id="LC54" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-49 ">    pipeline[<span class="pl-c1">0</span>].<span class="pl-smi">valid</span> = <span class="pl-c1">0</span>; <span class="pl-c"><span class="pl-c">//</span> New fetch stage</span></div>
...
<div id="LC57" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-k">int</span> <span class="pl-en">main</span>() {</div>
<div id="LC58" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">    PipelineStage pipeline[NUM_STAGES] = {<span class="pl-c1">0</span>};</div>
<div id="LC59" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">
</div>
<div id="LC60" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">    <span class="pl-k">for</span> (<span class="pl-k">int</span> cycle = <span class="pl-c1">0</span>; cycle &lt; <span class="pl-c1">10</span>; cycle++) {</div>
<div id="LC61" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">        <span class="pl-c1">printf</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Cycle %d:<span class="pl-cce">\n</span><span class="pl-pds">&quot;</span></span>, cycle + <span class="pl-c1">1</span>);</div>
<div id="LC62" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">        <span class="pl-c1">pipeline_step</span>(pipeline);</div>
<div id="LC63" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">        <span class="pl-c1">pipeline_shift</span>(pipeline);</div>
<div id="LC64" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">        <span class="pl-c1">sleep</span>(<span class="pl-c1">1</span>); <span class="pl-c"><span class="pl-c">//</span> Simulate time delay for each cycle</span></div>
<div id="LC65" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">        <span class="pl-c1">printf</span>(<span class="pl-s"><span class="pl-pds">&quot;</span><span class="pl-cce">\n</span><span class="pl-pds">&quot;</span></span>);</div>
<div id="LC66" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">    }</div>
<div id="LC67" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">
</div>
<div id="LC68" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-56 ">    <span class="pl-k">return</span> <span class="pl-c1">0</span>;</div>
